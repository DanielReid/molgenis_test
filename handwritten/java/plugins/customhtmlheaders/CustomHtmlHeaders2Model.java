...
/**
 * CustomHtmlHeaders2Model takes care of all state and it can have helper methods to query the database.
 ...
 */
public class CustomHtmlHeaders2Model extends EasyPluginModel
{
	//a system veriable that is needed by tomcat
	private static final long serialVersionUID = 1L;
	//this string can be referenced from CustomHtmlHeaders2View.ftl template as ${model.helloWorld}
	public String helloWorld = "hello World";
	//this date can be referenced from CustomHtmlHeaders2View.ftl template as ${model.date}
	...
	public CustomHtmlHeaders2Model(CustomHtmlHeaders2 controller)
	{
